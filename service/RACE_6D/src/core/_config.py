...
class BaseConfig(object):
    ...
    def build_mixed_dataloader(self):
        """Multiple domain datasets with custom sampling ratios"""
        from ..data.dataset import MixedDomainDataset
        
        cfg = self.yaml_cfg['train_dataloader']
        mixed_cfg = cfg['mixed_domains']
        ...
        bs = self.get_rank_batch_size(cfg)
        loader = DataLoader(
            mixed_dataset,
            batch_size=bs,
        ...
        loader.shuffle = cfg.get('shuffle', True)
