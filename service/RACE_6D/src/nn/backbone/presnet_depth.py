...
class PResNet_depth(nn.Module):
    def __init__(self, depth, variant='d', num_stages=4, return_idx=[0,1,2,3],
        ...
        if variant in ['c', 'd']:
            ...
            conv_def = [[in_chans, ch_in, 7, 2, "conv1_1"]]
        ...
        if pretrained:
            ...
            if k in state:
                ...
                cout, cin_old, kh, kw = w.shape
                cin_new = self.conv1[0].conv.weight.shape[1]
                if cin_new != cin_old:
