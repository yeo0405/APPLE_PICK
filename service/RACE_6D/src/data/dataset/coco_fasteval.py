...
https://github.com/PaddlePaddle/PaddleDetection/blob/develop/ppdet/metrics/fast_cocoeval
"""
...
class FastCOCOeval(COCOeval):
    ...
    def evaluate(self):
        ...
        def convert_instances_to_cpp(instances, is_det=False) -> None:
